<template>
  <page-layout-v2
    title="Get your car serviced in Bradfield"
...
export default {
  ...
  head: {
    title: "Car Repair in Bradfield| Garage in Bradfield",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Bradfield for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
