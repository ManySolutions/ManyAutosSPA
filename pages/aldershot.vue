      ...
      <div class="row">
        <section class="col-12 col-lg-9 ma-page-main-side margin-bottom-20" style="padding-top: 40px;">
          ...
          <v-expansion-panels popout>
            ...
            <v-expansion-panel v-for="(item,i) in 1" :key="i">
              <v-expansion-panel-header class="card-header">
                Do you provide Timing Bet/Cambelt changing service for Aldershot?
              </v-expansion-panel-header>
              <v-expansion-panel-content class="card-header-body">
...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      {
        name: 'keywords', 
        content: 'MOT and car repair services inAldershot ,Car services in Aldershot , collection and delivery from Aldershot, finance for cars repair in Aldershot, clutch repairs in Aldershot, MOT tests in Aldershot, alternator repair and replacement in Aldershot, Cambelt changing service in Aldershot, head gasket repair in  Aldershot'
      },
      {
        property: "og:title", 
