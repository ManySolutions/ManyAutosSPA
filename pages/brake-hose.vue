<template>
  <page-layout
    title='Brake Hose'
    heading-bg='customer-v2/static-pages/allpics/brakehose1.jpg'
  >
    <div class="container">
      <div class="row">
        <section class="col-12 col-lg-9 ma-page-main-side margin-bottom-20" style="padding-top: 40px;">
          ...
          <v-expansion-panels popout>
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Brake Hose Replacement Free Collection and Delivery
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
    ...
    meta: [
      {
        ...
        content: 'Many Autos LTD repair and replace Brake Hose for all makes and models in United Kingdom. If you need help with front brake hose feel free to book your car service online at Many Autos LTD. Many Autos also provide free collection and Delivery service from your home or place of work.'
      },
      {
        name: 'keywords', 
