<template>
  <page-layout-v2
    title="Get your car serviced in Wokingham"
...
export default {
  ...
  head: {
    title: "Car Repair in Wokingham| Garage in Wokingham",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Wokingham for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
