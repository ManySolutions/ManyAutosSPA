        ...
        <div class="about-content">
          <div class="ab-title">
            ...
            <p>Covid-19 has affected everyone in a different way. Many people are struggling financially due
              ...
              the <NuxtLink to='/car-service'>car repair pay later service</NuxtLink>. You can pay your dues in
              installments for the next 4 or 6
              months.</p>
            <p>This <strong>vehicle servicing installments plan</strong> is devised for your ease and comfort. We don’t
              want
...
export default {
  ...
  head: {
    ...
    meta: [
      {
        name: 'description', 
        content: 'We provide our customers with a risk-free environment. We are concerned for you and want to help you during covid-19. We are offering an affordable payment plan for you.'
      },
      {
        name: 'keywords', 
        content: 'car repair payment plan, pay later auto repair, car service installments, vehicle service plan, fix now pay later '
      },
      {
        property: "og:title", 
        content: "Car Repair During COVID 19 | Car Repair Instalment Plan | ManyAutos LTD"
      },
      {
        property: "og:type", 
        content: "website"
...
@media (min-width: 560px) and (max-width:960px){
  .covid-page .booking .image-one{

    max-width: 57%;
    text-align: center;
  }
  .covid-page .booking .image-two{
