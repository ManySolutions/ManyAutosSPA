<template>
  <page-layout-v2
    title="Get your car serviced in Twyford"
...
export default {
  ...
  head: {
    title: "Car Repair in Twyford| Garage in Twyford",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Twyford for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
