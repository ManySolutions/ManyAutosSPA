<template>
  <page-layout-v2
    title="Get your car serviced in Goring"
...
export default {
  ...
  head: {
    title: "Car Repair in Goring| Garage in Goring",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Goring for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
