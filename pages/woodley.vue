<template>
  <page-layout-v2
    title="Get your car serviced in Woodley"
...
export default {
  ...
  head: {
    title: "Car Repair in Woodley| Garage in Woodley",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Woodley for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
