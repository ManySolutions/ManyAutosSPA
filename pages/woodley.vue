  ...
  >
      ...
      <div class="row">
        <section class="col-12 col-lg-9 ma-page-main-side margin-bottom-20" style="padding-top: 40px;">
          <div class="row">
            <div class="col-12">
              <p class="text-teal text-18 justify" style="padding-top: 30px;">We cover the Woodley area for all car
          ...
          <v-expansion-panels popout>
            <v-expansion-panel  class="icon">
              ...
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">Yes, we believe that we offer a valuable product with our Free
                  Collection and Delivery Service from Woodley, we can collect either from your place of work or
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                How does collection and delivery work from Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                Many Autos operate a fleet of pool cars with a dedicated driver, so wherever in Woodley we are
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you provide finance for cars repair in Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                Yes, you can pay for all or some of your car repair bill with car service and repair finance if you are
                from Woodley. From replacing car parts to a full transmission, engine, repair, service, mot repair
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                On what services is finance available from Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you do clutch repairs for cars in Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">A lot of happy customers from Woodley have found out how Many
            ...
            <v-expansion-panel  class="icon">
              ...
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">MOT testing is required by law on all vehicles in the UK that are 3
                  ...
                  a MOT garage with DVSA-approved examiners. So if you are in Woodley and require an MOT test, give
                  us
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you provide alternator repair and replacement service for Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">We provide full alternator repair and replacement services in
                  Woodley. An automotive charging system is made up of three major components the battery, the
                  voltage
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you provide Timing Belt/Cambelt changing service for Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">Timing Belt/Cambelt replacement according to your car manufacturer
                  ...
                  Woodley area. For more information please visit our <a
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Can you do repairs to the head gasket if I am based in Woodley?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">We do head gasket repairs and replacements for the Woodley
                  area.
...
export default {
  ...
  head: {
    ...
    meta: [
      {
        name: 'description', 
        content: 'We repair and Service all makes and models off vehicle in Woodley, United Kingdom. We also provide free collection and Delivery service from your home or place of work in Woodley.'
      },
      {
        name: 'keywords', 
