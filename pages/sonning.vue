<template>
  <page-layout
    title=' Sonning'
    heading-bg='customer-v2/static-pages/allpics/sonning1.jpg'
  >
        <div class="container">
      <div class="row">
        <section class="col-12 col-lg-9 ma-page-main-side margin-bottom-20" style="padding-top: 40px;">
          <div class="row">
            <div class="col-12">
              <p class="text-teal text-18 justify" style="padding-top: 30px;">We cover the  Sonning area for all car
          ...
          <v-expansion-panels popout>
            <v-expansion-panel  class="icon">
              <v-expansion-panel-header class="card-header">
                Do you offer free collection and delivery from  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">Yes, we believe that we offer a valuable product with our Free
                  Collection and Delivery Service from  Sonning, we can collect either from your place of work or
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                How does collection and delivery work from  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                Many Autos operate a fleet of pool cars with a dedicated driver, so wherever in  Sonning we are
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you provide finance for cars repair in  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                Yes, you can pay for all or some of your car repair bill with car service and repair finance if you are
                from  Sonning. From replacing car parts to a full transmission, engine, repair, service, mot repair
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                On what services is finance available from  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you do clutch repairs for cars in  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">A lot of happy customers from  Sonning have found out how Many
            ...
            <v-expansion-panel  class="icon">
              <v-expansion-panel-header class="card-header">
                Do you offer MOT tests in  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">MOT testing is required by law on all vehicles in the UK that are 3
                  ...
                  a MOT garage with DVSA-approved examiners. So if you are in  Sonning and require an MOT test, give
                  us
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you provide alternator repair and replacement service for  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">We provide full alternator repair and replacement services in
                   Sonning. An automotive charging system is made up of three major components the battery, the
                  voltage
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Do you provide Timing Belt/Cambelt changing service for  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">Timing Belt/Cambelt replacement according to your car manufacturer
                  ...
                  are able to check and replace timing belts/cambelts for all makes and models of vehicles in the
                   Sonning area. For more information please visit our <a
            ...
            <v-expansion-panel >
              <v-expansion-panel-header class="card-header">
                Can you do repairs to the head gasket if I am based in  Sonning?
              </v-expansion-panel-header>
              <v-expansion-panel-content eager class="card-header-body">
                <p class="text-teal text-18 justify">We do head gasket repairs and replacements for the  Sonning
                  area.
    ...
    meta: [
      {
        ...
        content: 'We repair and Service all makes and models off vehicle in  Sonning, United Kingdom. We also provide free collection and Delivery service from your home or place of work in  Sonning.'
      },
      {
        name: 'keywords', 
        content: 'MOT and car repair services in Sonning ,Car services in  Sonning , collection and delivery from  Sonning, finance for cars repair in  Sonning, clutch repairs in  Sonning, MOT tests in  Sonning, alternator repair and replacement in  Sonning, Cambelt changing service in  Sonning, head gasket repair in   Sonning'
      },
      {
        property: "og:title", 
        content: " Sonning | ManyAutos LTD"
      },
      {
        property: "og:type", 
        content: "website"
