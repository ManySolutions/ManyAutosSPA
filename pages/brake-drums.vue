...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      {
        name: 'keywords', 
        content: 'brake drums, rear brake drums, new brake drums, brake drums repair, brake drums replace, brake drums replacement, free collection and Delivery, Car Service'
      },
      {
        hid: 'og:title',
        property: "og:title", 
