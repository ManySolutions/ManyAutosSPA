<template>
  <page-layout-v2
    title="Get your car serviced in Pang Bourne"
...
export default {
  ...
  head: {
    title: "Car Repair in Pang Bourne| Garage in Pang Bourne",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Pang Bourne for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
