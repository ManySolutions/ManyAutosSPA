<template>
  <page-layout-v2
    title="Get your car serviced in Maidenhead"
...
export default {
  ...
  head: {
    title: "Car Repair in Maidenhead| Garage in Maidenhead",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Maidenhead for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
