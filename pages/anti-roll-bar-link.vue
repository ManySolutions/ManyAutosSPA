<template>
  <page-layout
    ...
    heading-bg='customer-v2/static-pages/allpics/anti-roll1.jpg'
  >
       <div class="container">
      <div class="row">
        <section class="col-12 col-lg-9 ma-page-main-side margin-bottom-20" style="padding-top: 40px;">
          <div class="row">
            <div class="col-12">
              <p class="text-teal text-18 justify">Anti-roll bar is a part of a car's suspension system. They are sometimes also called anti-sway bars. Their purpose in life is to try to keep the car's body from rolling in a sharp turn. Think about what happens to a car in a sharp turn.</p>
            </div>
          </div>
            ...
            <v-expansion-panel >
              ...
              <v-expansion-panel-content eager class="card-header-body">
                ...
                <ul class="list">
                  ...
                  <li>Poor handling or loose steering wheel. </li>
                  <li>ABS Pump </li>
                  <li>Check during tyre replacement or suspension inspection. </li>
                </ul>
              </v-expansion-panel-content>
            </v-expansion-panel>
            <v-expansion-panel >
