<template>
  ...
  <p>This privacy policy applies between you, the User of this Website and Many Autos, the owner and provider of this Website. Many Autos takes the privacy of your information very seriously. This privacy policy applies to our use of any and all Data collected by us or provided by you in relation to your use of the Website.</p>
  <p>This privacy policy should be read alongside, and in addition to, our Terms and Conditions, which can be found <a href="/terms-and-conditions">here</a></p>
  ...
  <ol>
      <li>
          ...
          <ul>
              <li>Data collectively all information that you submit to Many Autos via the Website. This definition incorporates, where applicable, the definitions provided in the Data Protection Laws;</li>
              <li>Cookies a small text file placed on your computer by this Website when you visit certain parts of the Website and/or when you use certain features of the Website. Details of the cookies used by this Website are set out in the clause below (Cookies);</li>
          </ul>
          <h5>Data Protection</h5>
          <p>Laws any applicable law relating to the processing of personal Data, including but not limited to the Directive 96/46/EC (Data Protection Directive) or the GDPR, and any national implementing laws, regulations and secondary legislation, for as long as the GDPR is effective in the UK;</p>
          <p>GDPR the General Data Protection Regulation (EU) 2016/679;</p>
          <h5>Many Autos</h5>
          <p>we or us Many Autos, a company incorporated in England and Wales with registered number 09933100 whose registered office is at 12 Elk Path, Berkshire, RG7 1WE;</p>
          <h5>UK and EU</h5>
          <p>Cookie Law the Privacy and Electronic Communications (EC Directive) Regulations 2003 as amended by the Privacy and Electronic Communications (EC Directive) (Amendment) Regulations 2011;</p>
          <p>User or you any third party that accesses the Website and is not either (i) employed by Many Autos and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to Many Autos and accessing the Website in connection with the provision of such services; and</p>
          <p>Website the website that you are currently using, https://www.manyautosltd.com, and any sub-domains of this site unless expressly excluded by their own terms and conditions</p>
      </li>
      <li>
  ...
  <ol>
      <li>This privacy policy applies only to the actions of Many Autos and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.</li>
      <li>For purposes of the applicable Data Protection Laws, Many Autos is the "data controller". This means that Many Autos determines the purposes for which, and the manner in which, your Data is processed.</li>
  </ol>
  ...
  <ol>
      <li>
          Many Autos will collect your Data in a number of ways, for example:
          <ol>
  ...
  <ol>
      <li>
          ...
          <ol>
              <li>our employees, agents and/or professional advisors - to manage the customer booking and provide the services required;</li>
              <li>third party service providers who provide services to us which require the processing of personal data - to ensure efficient service is provided to the customer, including the work that is required, collection and delivery of the vehicle;</li>
  ...
  <ol>
      ...
      <li>Technical and organisational measures include measures to deal with any suspected data breach. If you suspect any misuse or loss or unauthorised access to your Data, please let us know immediately by contacting us via this e-mail at <a href="mailto:info@manyautosltd.com">info@manyautosltd.com</a></li>
  ...
  <ol>
      ...
      <li>To make enquiries, exercise any of your rights set out above, or withdraw your consent to the processing of your Data (where consent is our legal basis for processing your Data), please contact us via this e-mail  at <a href="mailto:info@manyautosltd.com">info@manyautosltd.com</a></li>
      <li>If you are not satisfied with the way a complaint you make in relation to your Data is handled by us, you may be able to refer your complaint to the relevant data protection authority. For the UK, this is the Information Commissioner's Office (ICO). The ICO's contact details can be found on their website at <a href="https://ico.org.uk/" target="_blank"></a>https://ico.org.uk</li>
  ...
  <ol>
      <li>Many Autos may, from time to time, expand or reduce our business and this may involve the sale and/or the transfer of control of all or part of Many Autos. Data provided by Users will, where it is relevant to any part of our business so transferred, be transferred along with that part and the new owner or newly controlling party will, under the terms of this privacy policy, be permitted to use the Data for the purposes for which it was originally supplied to us.</li>
  ...
  <h4>Cookies</h4>
  <ol>
      <li>This Website may place and access certain Cookies on your computer. Many Autos uses Cookies to improve your experience of using the Website and to improve our range of services. Many Autos has carefully chosen these Cookies and has taken steps to ensure that your privacy is protected and respected at all times.</li>
      <li>All Cookies used by this Website are used in accordance with current UK and EU Cookie Law.</li>
      <li>Before the Website places Cookies on your computer, you will be presented with a message bar requesting your consent to set those Cookies. By giving your consent to the placing of Cookies, you are enabling Many Autos to provide a better experience and service to you. You may, if you wish, deny consent to the placing of Cookies; however certain features of the Website may not function fully or as intended.</li>
      <li>
...
<h4>General</h4>
  <ol>
      <li>Many Autos reserves the right to change this privacy policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Website and you are deemed to have accepted the terms of the privacy policy on your first use of the Website following the alterations. You may contact Many Autos by email at info@manyautosltd.com.</li>
  </ol>
  <h4>Cookies</h4>
...
<h4>Description of Cookie Purpose</h4>
<p>user information to store your username to remember you and maintain your session whilst you are using our website.</p>
</div>
  </page-layout>
</template>
