<template>
  <page-layout-v2
    title="Get your car serviced in Henley On Thames"
...
export default {
  ...
  head: {
    title: "Car Repair in Henley On Thames| Garage in Henley On Thames",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Henley On Thames for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
