<template>
  <page-layout-v2
    title="Get your car serviced in Thatcham"
...
export default {
  ...
  head: {
    title: "Car Repair in Thatcham| Garage in Thatcham",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Thatcham for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
