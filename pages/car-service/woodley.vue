<template>
  <page-layout-v2
    title="Car Service in Woodley"
    heading-bg='customer-v2/static-pages/allpics/woodley1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Woodley'
    redirect-to='/booking/create/services'
  >
  <template #overview>
  <p>
    Woodley is a town and civil parish in Berkshire, England. It is only four miles 
    east of Reading. Woodley is well-known for its great school and living 
    standards. It is named as one of the top 20 places to live in the family hotspot 
    annual report.
  </p>    
</template>
    <template #blog>
      <p>We cover the Woodley area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Woodley. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Woodley?
      </h2>
      <p>
        The average cost of full service in Woodley is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Woodley</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Woodley, it
      ...
      <h2 class="font-weight-600">
        Do you offer MOT tests in Woodley? 
      </h2>
      <p>Yes, we provide MOT for all the vehicles present in Woodley despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Woodley and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Woodley?
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Woodley</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Woodley | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Woodley - Find the best garages in Woodley for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Woodley, Car repairs in Woodley, Garage in Woodley, Car Service in Woodley",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Woodley| Garage in Woodley",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/woodley',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/woodley1.jpg",
      },
      {
        hid: "og:site_name",
