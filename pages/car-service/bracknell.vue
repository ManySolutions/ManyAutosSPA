<template>
  <page-layout-v2
    title="Car service in Bracknell"
    heading-bg='customer-v2/static-pages/allpics/bracknell1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Bracknell'
    redirect-to='/booking/create/services'
  >
    <template #overview>
      <p>
        Bracknell is a large town and civil parish in Berkshire, England. Bracknell being a market village and a part of
        the Windsor Great Forest grew drastically and gained a lot of attention in the mid-20th century. It is a town of
        strong character best known for its Victorian brickyards and the bricks made by Thomas Lawrence and Sons which
        were used in the Albert Hall and multiple other places. Bracknell is a great town to live in, not only because
        of its aesthetic and vintage vibe but also because there are great houses at reasonable prices and good schools
        in the area.
      </p>
    </template>
    <template #blog>
      <p>We cover the Bracknell area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Bracknell. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Bracknell?
      </h2>
      <p>
        The average cost of full service in Bracknell is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Bracknell</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Bracknell, it
      ...
      <p>
        ...
        Bracknell</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Bracknell | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Bracknell - Find the best garages in Bracknell for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Bracknell, Car repairs in Bracknell, Garage in Bracknell, Car Service in Bracknell",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Bracknell| Garage in Bracknell",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/bracknell',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/bracknell1.jpg",
      },
      {
        hid: "og:site_name",
