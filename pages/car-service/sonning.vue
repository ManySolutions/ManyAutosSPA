<template>
  ...
  <p>
    ...
    Jerome K. Jerome has beautifully described this village in his book as “the most fairy-like
    little nook on the whole river”. Sonning has a great updated reputation and it is a thriving
    village. It has good transport links and shops.
  </p>    
</template>
    <template #blog>
      <p>We cover the Sonning area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Sonning. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Sonning?
      </h2>
      <p>
        The average cost of full service in Sonning is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Sonning</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Sonning, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Sonning despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Sonning and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Sonning</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Sonning | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Sonning - Find the best garages in Sonning for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Sonning, Car repairs in Sonning, Garage in Sonning, Car Service in Sonning",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Sonning| Garage in Sonning",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/sonning',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/sonning1.jpg",
      },
      {
        hid: "og:site_name",
