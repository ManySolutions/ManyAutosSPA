<template>
  <page-layout-v2
    title="Car Service in Goring"
    heading-bg='customer-v2/static-pages/allpics/goring1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos And Goring'
    redirect-to='/booking/create/services'
  >
    <template #overview>
      <p>
        Goring is a village and civil parish on the River Thames in South Oxford shire, England. It is well known for
        its aesthetic beauty and pleasing to eyes landscapes. Since Victorian times, it has been considered a perfect
        spot for a vacation. It has multiple religious’ sites that people like to visit often.
      </p>
    </template>
    <template #blog>
      <p>We cover the Goring area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Goring. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Goring?
      </h2>
      <p>
        The average cost of full service in Goring is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Goring</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Goring, it
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Goring? 
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Goring</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Goring | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Goring - Find the best garages in Goring for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Goring, Car repairs in Goring, Garage in Goring, Car Service in Goring",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Goring| Garage in Goring",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/goring',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/goring1.jpg",
      },
      {
        hid: "og:site_name",
