...
export default {
  ...
  head: {
    title: "Car Service in Newbury | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Newbury - Find the best garages in Newbury for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
