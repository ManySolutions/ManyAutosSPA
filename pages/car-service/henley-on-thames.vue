<template>
  <page-layout-v2
    title="Car Serviced in Henley On Thames"
    heading-bg='customer-v2/static-pages/allpics/henley-on-thames1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos And Henley On Thames'
    redirect-to='/booking/create/services'
  >
    <template #overview>
      <p>
        Henley on Thames is a town & civil parish on the Thames River in Oxford shire, England. It is well known as the
        centre of rowing. The Henley royal regatta is held every summer on the Henley reach. Henley reach is a river on
        the north of the town. The river was extended artificially at the time. This event became a royal event after
        prince Albert became a respectable patron of the regatta.
      </p>
    </template>
    <template #blog>
      <p>We cover the Henley On Thames area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Henley On Thames. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Henley On Thames?
      </h2>
      <p>
        The average cost of full service in Henley On Thames is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Henley On Thames</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Henley On Thames, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Henley On Thames despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Henley On Thames and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Henley On Thames</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Serviced in Henley On Thames | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Serviced in Henley On Thames - Find the best garages in Henley On Thames for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Henley On Thames, Car repairs in Henley On Thames, Garage in Henley On Thames, Car Service in Henley On Thames",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Henley On Thames| Garage in Henley On Thames",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/henley-on-thames',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/henley-on-thames1.jpg",
      },
      {
        hid: "og:site_name",
