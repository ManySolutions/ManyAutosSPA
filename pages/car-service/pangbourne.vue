<template>
  <page-layout-v2
    title="Car Service in Pang Bourne"
...
<template #overview>
  <p>
    ...
    second hand and brand new sports cars. It is said that Pang Bourne is a beautiful village
    on the river, with good and welcoming people. It also has great schools.
  </p>    
</template>
    <template #blog>
      <p>We cover the Pang Bourne area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Pang Bourne. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Pang Bourne?
      </h2>
      <p>
        The average cost of full service in Pang Bourne is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Pang Bourne</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Pang Bourne, it
      ...
      <h2 class="font-weight-600">
        Do you offer MOT tests in Pang Bourne? 
      </h2>
      <p>Yes, we provide MOT for all the vehicles present in Pang Bourne despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Pang Bourne and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Pang Bourne?
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Pang Bourne</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Pang Bourne | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Pang Bourne - Find the best garages in Pang Bourne for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Pang Bourne, Car repairs in Pang Bourne, Garage in Pang Bourne, Car Service in Pang Bourne",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Pang Bourne| Garage in Pang Bourne",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/pangbourne',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/pangbourne1.jpg",
      },
      {
        hid: "og:site_name",
