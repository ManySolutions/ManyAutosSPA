<template>
  <page-layout-v2
    title="Car service in Basingstoke"
  ...
  >
    <template #overview>
      <p>
        Basingstoke is a town in the country of Hampshire, situated in south-central England. It was named as one of the
        top 50 places to live in Britain in 2020, by Halifax's annual Quality of Life survey. Basingstoke stands out due
        to its cultural heritage. It is a modern, fast-paced city, surrounded by beautiful villages of the eye-pleasing
        Hampshire countryside. It is the home for an increasing number of worth acknowledging businesses.
      </p>
    </template>
    <template #blog>
      <p>We cover the Basingstoke area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for
        all your automotive needs. we use the latest equipment, allowing our qualified technicians and mechanics to
        diagnose any problems quickly and efficiently.</p>
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Basingstoke. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Basingstoke?
      </h2>
      <p>
        The average cost of full service in Basingstoke is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Basingstoke</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Basingstoke, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Basingstoke despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Basingstoke and require an MOT test, book online now!.
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Basingstoke</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Basingstoke | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Basingstoke - Find the best garages in Basingstoke for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Basingstoke, Car repairs in Basingstoke, Garage in Basingstoke, Car Service in Basingstoke",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Basingstoke| Garage in Basingstoke",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/basingstoke',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/basingstoke1.jpg",
      },
      {
        hid: "og:site_name",
