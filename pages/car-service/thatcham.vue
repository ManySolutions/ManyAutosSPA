<template>
  <page-layout-v2
    title="Car Service in Thatcham"
    heading-bg='customer-v2/static-pages/allpics/thatcham1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Thatcham'
    redirect-to='/booking/create/services'
  >
  <template #overview>
  <p>
    Thatcham is a historic market town in the historic county of Berkshire, England. 
    The area contains evidence of occupation from prehistoric times. It is also listed 
    in the Guinness book of courts as the strongest claimant to being the oldest 
    continuously inhabited place in Britain.
  </p>    
</template>
    <template #blog>
      <p>We cover the Thatcham area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Thatcham. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Thatcham?
      </h2>
      <p>
        The average cost of full service in Thatcham is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Thatcham</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Thatcham, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Thatcham despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Thatcham and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Thatcham</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Thatcham | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Thatcham - Find the best garages in Thatcham for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Thatcham, Car repairs in Thatcham, Garage in Thatcham, Car Service in Thatcham",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Thatcham| Garage in Thatcham",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/thatcham',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/thatcham1.jpg",
      },
      {
        hid: "og:site_name",
