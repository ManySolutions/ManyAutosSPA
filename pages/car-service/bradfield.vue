<template>
  <page-layout-v2
    title="Car service in Bradfield"
    heading-bg='customer-v2/static-pages/allpics/bradfield1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Bradfield'
    redirect-to='/booking/create/services'
  >
    <template #overview>
      <p>
        Bradfield is known as a village and civil parish in Berkshire, England. You can find multiple farms and little
        amounts of woodlands. The major settlements of this village are Bradfield Southend, The Hamlet of Tutts Clump,
        and the medieval-founded nucleus. Bradfield’s most cherished achievement is the public school Bradfield College.
      </p>
    </template>
    <template #blog>
      <p>We cover the Bradfield area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Bradfield. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Bradfield?
      </h2>
      <p>
        The average cost of full service in Bradfield is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Bradfield</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Bradfield, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Bradfield despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Bradfield and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Bradfield</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Bradfield |  Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Bradfield - Find the best garages in Bradfield for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Bradfield, Car repairs in Bradfield, Garage in Bradfield, Car Service in Bradfield",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Bradfield| Garage in Bradfield",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/bradfield',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/bradfield1.jpg",
      },
      {
        hid: "og:site_name",
