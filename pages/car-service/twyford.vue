<template>
  <page-layout-v2
    title="Car Service in Twyford"
    heading-bg='customer-v2/static-pages/allpics/twyford1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Twyford'
    redirect-to='/booking/create/services'
  >
  <template #overview>
  <p>
    Twyford is a large village and civil parish in the English royal county of Berkshire. 
    It is a place where people like to put down roots, because of its superb range of 
    property and great schools. Twyford was originally an agricultural settlement but 
    it transformed into a junction after the introduction of the railway in 1838.
  </p>    
</template>
    <template #blog>
      <p>We cover the Twyford area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Twyford. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Twyford?
      </h2>
      <p>
        The average cost of full service in Twyford is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Twyford</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Twyford, it
      ...
      <h2 class="font-weight-600">
        Do you offer MOT tests in Twyford? 
      </h2>
      <p>Yes, we provide MOT for all the vehicles present in Twyford despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Twyford and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Twyford?
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Twyford</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Twyford | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Twyford - Find the best garages in Twyford for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Twyford, Car repairs in Twyford, Garage in Twyford, Car Service in Twyford",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Twyford| Garage in Twyford",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/twyford',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/twyford1.jpg",
      },
      {
        hid: "og:site_name",
