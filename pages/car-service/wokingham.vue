<template>
  <page-layout-v2
    title="Car Service in Wokingham"
    heading-bg='customer-v2/static-pages/allpics/wokingham1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Wokingham'
    redirect-to='/booking/create/services'
  >
  <template #overview>
  <p>
    Wokingham is a market town in Berkshire, England. It was famous for its bell foundry 
    which served many churches. Wokingham also had a good name as the producer of silk. 
    The town is a constituent part of the Reading Urban Area.
  </p>    
</template>
    <template #blog>
      <p>We cover the Wokingham area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Wokingham. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Wokingham?
      </h2>
      <p>
        The average cost of full service in Wokingham is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Wokingham</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Wokingham, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Wokingham despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Wokingham and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Wokingham</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Wokingham | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Wokingham - Find the best garages in Wokingham for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Wokingham, Car repairs in Wokingham, Garage in Wokingham, Car Service in Wokingham",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Wokingham| Garage in Wokingham",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/wokingham',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/wokingham1.jpg",
      },
      {
        hid: "og:site_name",
