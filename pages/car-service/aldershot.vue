<template>
  <page-layout-v2
    title="Car Service in Aldershot"
    heading-bg='customer-v2/static-pages/allpics/aldershot1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Aldershot'
    redirect-to='/booking/create/services'
  >
    <template #overview>
      <p>
        Aldershot is a town in the Rushmoor district of Hampshire, England. It is known as the “Home of British Army”
        and that was the main reason that led a small village to a Victorian town. As the home of the army, Aldershot
        offers an impressive insight into army and military history and also barracks for upcoming soldiers. The history
        is recorded and documented by multiple local museums. Aldershot is identified as a good place to live because of
        its nice area and beautiful parks. The prices are also a bit lower in the area.
      </p>
    </template>
    <template #blog>
      <p>We cover the Aldershot area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Aldershot. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Aldershot?
      </h2>
      <p>
        The average cost of full service in Aldershot is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Aldershot</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Aldershot, it
      ...
      <p>Yes, we provide MOT for all the vehicles present in Aldershot despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Aldershot and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <p>
        ...
        Aldershot</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Aldershot | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Aldershot - Find the best garages in Aldershot for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Aldershot, Car repairs in Aldershot, Garage in Aldershot, Car Service in Aldershot",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Aldershot| Garage in Aldershot",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/aldershot',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/aldershot1.jpg",
      },
      {
        hid: "og:site_name",
