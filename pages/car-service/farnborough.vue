<template>
  <page-layout-v2
    title="Car Service in Farnborough"
    heading-bg='customer-v2/static-pages/allpics/farnborough1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos And Farnborough'
    redirect-to='/booking/create/services'
  >
    <template #overview>
      <p>
        Farnborough is a town in northeast Hampshire, England. It was founded in the Saxon time and it was mentioned in
        the Domesday Book of 1806. Farnborough is a rather busy place. It is built up and also given the charms of
        Hampshire's picturesque villages. It is filled with vibrant port cities and market towns. Although most people
        don’t prefer living here due to the noise and crowd, it is still a good place.
      </p>
    </template>
    <template #blog>
      <p>We cover the Farnborough area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Farnborough. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Farnborough?
      </h2>
      <p>
        The average cost of full service in Farnborough is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Farnborough</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Farnborough, it
      ...
      <h2 class="font-weight-600">
        Do you offer MOT tests in Farnborough? 
      </h2>
      <p>Yes, we provide MOT for all the vehicles present in Farnborough despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Farnborough and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Farnborough? 
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Farnborough</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Farnborough | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Farnborough - Find the best garages in Farnborough for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Farnborough, Car repairs in Farnborough, Garage in Farnborough, Car Service in Farnborough",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Farnborough| Garage in Farnborough",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/farnborough',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/farnborough1.jpg",
      },
      {
        hid: "og:site_name",
