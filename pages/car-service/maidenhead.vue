<template>
  <page-layout-v2
    title="Car Service in Maidenhead"
    heading-bg='customer-v2/static-pages/allpics/maidenhead1.jpg'
    box-title='Book your service now'
    blog-topic='ManyAutos and Maidenhead'
    redirect-to='/booking/create/services'
  >
  <template #overview>
  <p>
    Maidenhead is a market town in Berkshire, England, on the south-western bank of the
    River Thames. It is well-known for its flat brick arches. The people living in maidenhead
    feel quite secure and joyed because of the pleasant living space,good schools, clean air,
    higher salaries and green outdoor spaces. Everything that is required to raise a happy
    family is present in this town. It was also named the best place to raise a family in 2020.
  </p>
  </template>
    <template #blog>
      <p>We cover the Maidenhead area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Maidenhead. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Maidenhead?
      </h2>
      <p>
        The average cost of full service in Maidenhead is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Maidenhead</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Maidenhead, it
      ...
      <h2 class="font-weight-600">
        Do you offer MOT tests in Maidenhead? 
      </h2>
      <p>Yes, we provide MOT for all the vehicles present in Maidenhead despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Maidenhead and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Maidenhead?
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Maidenhead</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Service in Maidenhead | Book Full Service Online",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Car Service in Maidenhead - Find the best garages in Maidenhead for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Maidenhead, Car repairs in Maidenhead, Garage in Maidenhead, Car Service in Maidenhead",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Maidenhead| Garage in Maidenhead",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/maidenhead',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/maidenhead1.jpg",
      },
      {
        hid: "og:site_name",
