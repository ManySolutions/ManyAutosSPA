<template>
  <page-layout-v2
    title="Get your car serviced in Basingstoke"
...
export default {
  ...
  head: {
    title: "Car Repair in Basingstoke| Garage in Basingstoke",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Basingstoke for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
