<template>
  <page-layout-v2
    title="Get your car serviced in Spencers Wood"
  ...
  <template #overview>
  <p>
    Spencers Wood is a village in the civil parish of Shin field, Berkshire.
    It is a great place to live as it has the best schools and beautiful houses. 
    Despite the local objections and dispute between villages, Spencers wood is 
    growing and making progress every day.
  </p>    
</template>
    <template #blog>
      <p>We cover the Spencers Wood area for all car servicing, MOT and repair needs. Manyautos is one-stop shopping for all
      ...
      <p>Forgetting to service the vehicle as per the manufacturer schedule can cause your car to get damaged and break
        ...
        you on the road. Everyone can easily access our website a book car repair services in Spencers Wood. At Many Autos
      ...
      <h2 class="font-weight-600">
        How much does Full Service cost in Spencers Wood?
      </h2>
      <p>
        The average cost of full service in Spencers Wood is £151. The price can range from £133 to £300, depending on the
      ...
      <p>
        ...
        Manyautos is only here to provide you with the best. We will scout for <strong>garages in Spencers Wood</strong> and provide you
      ...
      <p>
        ...
        reassemble price. But there is more to it than you thought. You can’t just choose any garage in Spencers Wood, it
      ...
      <h2 class="font-weight-600">
        Do you offer MOT tests in Spencers Wood? 
      </h2>
      <p>Yes, we provide MOT for all the vehicles present in Spencers Wood despite their make and model. An MOT is
        compulsory and cannot be ignored, so if you are in Spencers Wood and require an MOT test, book online now!
      </p>
      <h2 class="font-weight-600">
        How do we do this? 
      </h2>
      ...
      <h2 class="font-weight-600">
        Do you offer free collection and delivery from Spencers Wood?
      </h2>
      <p>
        Yes, we believe that we offer a valuable product with our Free Collection and Delivery <strong>car service in
        Spencers Wood</strong>. If your vehicle is drivable, we can collect it either from your place of work or from your home
...
export default {
  ...
  head: {
    title: "Car Repair in Spencers Wood| Garage in Spencers Wood",
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Find the best garages in Spencers Wood for car services. MOT, vehicle repairs and all kind of services are offered at Manyautos.",
      },
      {
        name: "keywords",
        content:
          "Spencers Wood, Car repairs in Spencers Wood, Garage in Spencers Wood, Car Service in Spencers Wood",
      },
      {
        hid: "og:title",
        property: "og:title",
        content: "Car Repair in Spencers Wood| Garage in Spencers Wood",
      },
      {
        hid: "og:type",
        property: "og:type",
      ...
      },
      {
        hid: "og:url",
        property: "og:url",
        content: process.env.APP_URL + '/spencers-wood',
      },
      {
        hid: "og:image",
        property: "og:image",
        content: "https://app.manyautosltd.com/assets/customer-v2/static-pages/allpics/spencerswood1.jpg",
      },
      {
        hid: "og:site_name",
